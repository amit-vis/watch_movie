...
import { deleteItem, getSingleData, selectedMovieSelector, toggleWatchStatus, updateDetails } from "../../redux/reducer/moviereducer";
            ...
            {selectedMovie ? (
                <>
                    ...
                    <div className="btn-container">
                        <button type="button" className="cancel" onClick={()=>handleDelete(movieId)}>Delete</button>
                        <a href={`/edit/${movieId}`} type="button" className="submit">Edit</a>
                    </div>
                    <ToastContainer />
                </>
            ) : (
